...
export type SssCore = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        {
          name: 'burnerRole';
          docs: ['Burner role PDA — its existence proves burn authorization.'];
        },
        {
          name: 'mint';
          writable: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'adminRole';
          docs: ["Admin's own role PDA — proves admin authorization."];
        },
        {
          name: 'grantee';
          docs: ['The address receiving the role.'];
        },
        {
          name: 'roleAccount';
          writable: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'mint';
          docs: ['The Token-2022 mint, created externally by the SDK before this instruction.'];
        },
        {
          name: 'adminRole';
          writable: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'roleAccount';
          docs: ['The role PDA being revoked. Closed and rent returned to admin.'];
          writable: true;
        },
      ];
      args: [];
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'config';
          docs: ['NO pause check — seizure works during emergencies.'];
          pda: {
            seeds: [
              {
                kind: 'const';
        ...
        {
          name: 'seizerRole';
          docs: ['Seizer role PDA — its existence proves seizure authorization.'];
        },
        {
          name: 'mint';
        },
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'adminRole';
          docs: ["The caller's admin role PDA — will be closed."];
          writable: true;
        },
        {
          name: 'newAuthority';
        ...
        {
          name: 'newAdminRole';
          docs: ["The new authority's admin role PDA — will be created."];
          writable: true;
        },
        {
          name: 'systemProgram';
    ...
    },
    {
      ...
      discriminator: [9, 215, 52, 77, 1, 9, 162, 17];
      accounts: [
        {
          name: 'admin';
          signer: true;
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [245, 109, 179, 54, 135, 92, 22, 64];
    },
    {
      name: 'configUpdated';
    ...
    },
    {
      ...
      discriminator: [173, 3, 52, 125, 217, 125, 167, 81];
    },
    {
      name: 'operationsUnpaused';
      discriminator: [54, 216, 228, 170, 9, 168, 101, 17];
    },
    {
      name: 'roleGranted';
      discriminator: [220, 183, 89, 228, 143, 63, 246, 58];
    },
    {
      name: 'roleRevoked';
    ...
    },
    {
      ...
      discriminator: [238, 217, 135, 14, 147, 33, 221, 169];
    },
    {
      name: 'tokensBurned';
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ['Override preset default for permanent delegate. If None, derived from preset.'];
            type: {
              option: 'bool';
            };
          },
          {
            ...
            docs: ['Override preset default for transfer hook. If None, derived from preset.'];
            type: {
              option: 'bool';
            };
          },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'amountMinted';
            docs: ['Cumulative amount minted by this minter. Only tracked for Role::Minter.'];
            type: 'u64';
          },
        ];
      };
